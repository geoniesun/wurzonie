...
file <- "E:/Eagle/courses/Active Remote Sensing Systems/MACKENNZIE/forlayoutbaltic/UNWR_sub.tif"
yourlegendtitle <- "Displacement in m"
yourlegendpalette <- "Spectral" #or other
yourcrs <- 25884 #change if needed #25884 is baltic or 3857
yourfilename <- "displace_baltic_plot.png"
...
myplot <- ggplot() +
  ...
  scale_fill_distiller(palette=yourlegendpalette, trans = "reverse") +
